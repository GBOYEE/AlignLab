...
├── requirements.txt
├── src/
│   └── generate_preferences.py   # CLI to generate demo datasets
├── data/
│   └── samples/
...
python src/generate_preferences.py --domain secure_code --num 10 --output data/samples/secure_code_preferences.jsonl
```
